...
WHERE HISTORY.START_DATE >= '2022-09-01';
...
FROM CAR_RENTAL_COMPANY_RENTAL_HISTORY AS HISTORY
WHERE HISTORY.START_DATE LIKE ('2022-09%')
ORDER BY HISTORY_ID DESC;

SELECT ROUND(FEE_SUM / CAR_COUNT) AS AVERAGE_FEE
FROM (SELECT SUM(DAILY_FEE) AS FEE_SUM, COUNT(CAR_ID) AS CAR_COUNT
      FROM CAR_RENTAL_COMPANY_CAR
      WHERE CAR_TYPE = 'SUV') AS CAR_RENTAL_SUM